...
public class ChatGuiD5 extends JFrame
{
	...
	public ChatGuiD5(IExternalAccess agent)
	{
		...
		nickname = ChatGuiD5.this.agent.getComponentIdentifier().getName();
	...
	public void addMessage(final String from, final String to, final String text)
	{
		SwingUtilities.invokeLater(new Runnable()
		{
			public void run()
			{
				...
				if(to.equals("#general")) {
				...
				} else if(from.equals(nickname) || from.equals(currentChat)) {
					...
					chattersList.setCellRenderer(new ComplexCellRenderer(activeChats));
					//chattersList.setSelectionBackground(Color.cyan);
					//chattersList.setSelectedValue(currentChat, true);
					
					// chattersList.setCellRenderer( new WhiteYellowCellRenderer() );
				}
			}	
		});
	}
